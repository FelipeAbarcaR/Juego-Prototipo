...
if(setup == false)
{
	...
	{
		//find how many characters are on each page and store that numbre in the text_length array
		...
		for(var c = 0; c < text_length[p]; c++)
		{
			...
			//store individual chacarters in the "char" array
		...
		//Getting each characters coordinals
		for( var c = 0; c < text_length[p]; c++)
		{
			var _char_pos = c + 1;
			...
			//get current width of the line
			var _txt_up_to_charr = string_copy(text[p],1,_char_pos);
			var _current_txt_ww = string_width(_txt_up_to_charr) - string_width(char[c,p]);
			var _txt_line = 0;
			...
			for(var lb = 0; lb < line_break_num[p]; lb++)
			{
				...
				if(_char_pos >= line_break_pos[lb,p])
				{
					...
					_current_txt_ww = string_width(_str_copy);
		...
		char_x[c,p] = _txt_x + _current_txt_ww;
...
draw_sprite_ext(txtb_spr,txtb_img,
	_txtb_x, _txtb_y,
	textbox_width/txtb_spr_w, textbox_height/txtb_spr_h,
	0,c_white,1
);
